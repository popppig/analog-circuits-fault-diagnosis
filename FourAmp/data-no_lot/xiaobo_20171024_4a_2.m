...
%输入输出数据
%合并,50train50test
data(:,1:100)=fault0(:,101:200);
data(:,101:200)=fault1(:,101:200);%137*900
data(:,201:300)=fault2(:,101:200);
data(:,301:400)=fault3(:,101:200);
data(:,401:500)=fault4(:,101:200);
data(:,501:600)=fault5(:,101:200);
data(:,601:700)=fault6(:,101:200);
data(:,701:800)=fault7(:,101:200);
data(:,801:900)=fault8(:,101:200);
data(:,901:1000)=fault9(:,101:200);
data(:,1001:1100)=fault10(:,101:200);
data(:,1101:1200)=fault11(:,101:200);
data(:,1201:1300)=fault12(:,101:200);
%输入输出数据
test(:,1:100)=fault0(:,1:100);
test(:,101:200)=fault1(:,1:100);%137*900
test(:,201:300)=fault2(:,1:100);
test(:,301:400)=fault3(:,1:100);
test(:,401:500)=fault4(:,1:100);
test(:,501:600)=fault5(:,1:100);
test(:,601:700)=fault6(:,1:100);
test(:,701:800)=fault7(:,1:100);
test(:,801:900)=fault8(:,1:100);
test(:,901:1000)=fault9(:,1:100);
test(:,1001:1100)=fault10(:,1:100);
test(:,1101:1200)=fault11(:,1:100);
test(:,1201:1300)=fault12(:,1:100);
...
%%
%GridSearch寻优
[bestacc_1,bestc_1,bestg_1]=SVMcgForClass(output_train',eigenvalue_train1',-1,3,-1,3,5,0.5,0.5,4.5);
...
tic
[bestacc_3,bestc_3,bestg_3]= psoSVMcgForClass(output_train',eigenvalue_train1');
toc
